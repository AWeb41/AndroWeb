...
public class DeveloperKey
{
	...
	public static final String BROWSER_KEY = "AIzaSyAYgHbHDXV1x-wSdJPqdPiwq-2GgdWEqWk";
	public static final String PLAYLIST_ID = "PLiKkX4KV1eFLUxsoE7fIDx5RDSC0qOdC4";
	public static final String EXTRA_LOCAL_ONLY = "android.intent.extra.LOCAL_ONLY";
	public static final String VIDEO_ID = "QrAsNq5h7hU";
