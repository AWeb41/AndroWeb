...
public class AWebActivity extends AppCompatActivity {
    ...
    private static final String TAG = AWebActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_applicatione_aweb);
		...
		if(!check_permission(1)){
			ActivityCompat.requestPermissions(AWebActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, loc_perm);
		}
		get_location();
		...
		asw_view.setDownloadListener(new DownloadListener() {
			...
			public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
				...
				if(!check_permission(2)){
					ActivityCompat.requestPermissions(AWebActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, file_perm);
				}else {
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams){
                ...
                if(ASWP_FUPLOAD) {
                    ...
                    if (ASWP_CAMUPLOAD) {
                        ...
                        if (takePictureIntent.resolveActivity(AWebActivity.this.getPackageManager()) != null) {
                            File photoFile = null;
                            try {
    ...
    public void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            AWebActivity.this.setTaskDescription(taskDesc);
        }
        get_location();
    }
	...
	public boolean url_actions(WebView view, String url){
		...
		if (!ASWP_OFFLINE && !DetectConnection.isInternetAvailable(AWebActivity.this)) {
	...
	public void get_file(){
		...
		if (ASWP_FUPLOAD && ASWP_CAMUPLOAD && !check_permission(2) && !check_permission(3)) {
			ActivityCompat.requestPermissions(AWebActivity.this, perms, file_perm);
		...
		//Checking for CAMERA permissions
			...
			ActivityCompat.requestPermissions(AWebActivity.this, new String[]{Manifest.permission.CAMERA}, file_perm);
		}
	}
    ...
    public void get_location(){
		...
		if (ASWP_LOCATION && ((Build.VERSION.SDK_INT >= 23 && check_permission(1)) || Build.VERSION.SDK_INT < 23)) {
			...
			cookieManager.setAcceptCookie(true);
			GPSTrack gps;
			gps = new GPSTrack(AWebActivity.this);
    ...
    public void show_notification(int type, int id) {
        ...
        asw_notification = (NotificationManager) AWebActivity.this.getSystemService(Context.NOTIFICATION_SERVICE);
        Intent i = new Intent();
        if (type == 1) {
            i.setClass(AWebActivity.this, AWebActivity.class);
        } else if (type == 2) {
            i.setAction(Settings.ACTION_LOCATION_SOURCE_SETTINGS);
        } else {
            i.setAction(Settings.ACTION_APPLICATION_DETAILS_SETTINGS);
            i.addCategory(Intent.CATEGORY_DEFAULT);
            i.setData(Uri.parse("package:" + AWebActivity.this.getPackageName()));
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(AWebActivity.this, 0, i, PendingIntent.FLAG_UPDATE_CURRENT);

        Uri alarmSound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(AWebActivity.this, "");
        switch(type){
            case 1:
			...
			switch (keyCode) {
				case KeyEvent.KEYCODE_BACK:
					if (asw_view.canGoBack()) {
						...
						finish();
						ApplicationActivity.start(AWebActivity.this);
					}
					return true;
			}
		}
